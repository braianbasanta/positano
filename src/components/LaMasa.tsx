...
const dias = [
  {
    ...
    text: "Mezclamos harina «00» italiana, agua, sal marina y apenas una pizca de levadura. Amasamos hasta lograr una textura sedosa y la dejamos en reposo en frío.",
  },
  {
    num: "02",
    eyebrow: "Día dos",
...
const ingredientes = [
  { name: "Harina «00»", origin: "Caputo · Nápoles" },
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-14 md:grid-cols-2 md:gap-20">
          ...
          <div className="relative">
            ...
            <div className="relative bg-cream-deep px-8 py-12 sm:px-12 sm:py-14">
              ...
              <ol className="relative">
                <span
                  aria-hidden
                  className="pointer-events-none absolute left-[0.7rem] top-3 bottom-3 w-px bg-lemon/40"
                />

                {dias.map((dia, index) => (
                  <li
                    key={dia.num}
                    className={`relative grid grid-cols-[1.4rem_1fr] gap-5 sm:gap-6 ${
                      index === dias.length - 1 ? "" : "pb-10"
                    }`}
                  >
                    <div className="relative flex justify-center pt-2">
                      <span className="h-3 w-3 rounded-full bg-lemon shadow-[0_0_0_5px_var(--color-cream-deep)]" />
                    </div>
                    <div>
                      ...
                      <h3 className="mt-2 font-display text-2xl leading-tight text-ink sm:text-[1.65rem]">
                        {dia.title}
                      </h3>
        ...
        <Reveal delay={120}>
          ...
          <p className="mt-6 font-serif text-lg leading-relaxed text-ink-soft">
            ...
            controlada. Sin prisas ni levaduras forzadas — solo harina «00»
            italiana, agua, sal marina y tiempo. El resultado: ligera, alveolada
            y fácil de digerir.
          </p>
