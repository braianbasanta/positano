...
const DICT = {
  ...
  ca: {
    ...
    experiencia: ["Sense experiència", "Menys d'1 any", "1 – 2 anys", "3 – 5 anys", "Més de 5 anys"],
    idiomas: ["Castellà", "Català", "Italià", "Anglès", "Francès"],
    disponibilidad: ["Immediata", "En 1 – 2 setmanes", "En un mes", "Més d'un mes"],
    jornada: ["Completa", "Parcial", "Caps de setmana", "Indiferent"],
    documentacion: ["Sí, en regla (UE / permís de treball)", "En tràmit", "Encara no en tinc"],
    steps: [
      { title: "Dades personals", hint: "Explica'ns qui ets" },
      { title: "El teu perfil", hint: "Lloc de feina i experiència" },
      { title: "Detalls", hint: "Idiomes, jornada i disponibilitat" },
      { title: "El teu CV", hint: "Adjunta el teu currículum i envia'l" },
    ],
    fileTooBig: (mb: number) => `El fitxer supera els ${mb} MB.`,
    sendError: "No s'ha pogut enviar la candidatura.",
    genericError: "Error en enviar el formulari.",
    okEyebrow: "Gràcies!",
    okTitle: "La teva candidatura està en camí",
    okBodyPre: "Hem rebut el teu CV. T'escriurem a",
    okBodyPost: "si el teu perfil encaixa amb alguna de les nostres vacants.",
    progress: (n: number, title: string) => `Pas ${n} / 4 · ${title}`,
    nombre: "Nom complet *",
    email: "Email *",
    telefono: "Telèfon *",
    nacimiento: "Data de naixement",
    ciudad: "Ciutat de residència",
    puestoLabel: "Lloc de feina que sol·licites *",
    expLabel: "Anys d'experiència *",
    idiomasLabel: "Idiomes que parles",
    dispLabel: "Disponibilitat *",
    jornadaLabel: "Tipus de jornada *",
    docLabel: "Documentació per treballar a Espanya *",
    motivacion: "Per què vols treballar a Positano? (opcional)",
    motivacionPlaceholder: "Explica'ns alguna cosa sobre tu…",
    cvLabel: "Adjunta el teu CV *",
    cvFormats: (mb: number) => `Formats acceptats: PDF, Word, RTF, JPG, PNG. Màx. ${mb} MB.`,
    cvSelected: "Fitxer seleccionat",
    cvSelect: "Selecciona un fitxer",
    cvUpload: "Pujar el CV",
    atras: "← Enrere",
    continuar: "Continuar",
    enviando: "Enviant…",
    enviar: "Enviar candidatura",
