...
const title = "Le menu · Pizza napolitaine et pâtes fraîches · Positano BCN";
const description =
  "La carte du Positano : pizza napolitaine à la pâte fermentée pendant 48 heures, pâtes fraîches, antipasti, risottos et plats principaux. Restaurant italien situé dans le quartier de l'Eixample, à Barcelone.";

export const metadata: Metadata = {
  title,
  description,
  alternates: alternatesForPage("menu", "fr"),
  ...socialFor({ title, description, path: "/fr/carte", locale: "fr" }),
};

export default function MenuFrPage() {
  return (
    <>
      <JsonLd data={menuJsonLd("fr")} />
      <JsonLd
        data={breadcrumbJsonLd([
          { name: "Accueil", path: "/fr" },
          { name: "Menu", path: "/fr/carte" },
        ])}
      />
      <SiteHeader lang="fr" />
      <main>
        ...
        <section className="relative overflow-hidden bg-ink px-6 pb-20 pt-36 text-center md:pt-44">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mt-6 font-serif text-lg leading-relaxed text-cream/85 md:text-xl">
              Pizza napolitaine à la pâte fermentée pendant 48 heures, cuite à 400 °C avec des ingrédients 100 % italiens. Chaque plat raconte une histoire du sud de l&apos;Italie.
            </p>
        ...
        <div className="bg-cream px-6 py-20 md:py-28">
          ...
          <div className="mx-auto mt-20 max-w-5xl">
            <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2 text-[0.88rem] uppercase tracking-[0.22em] text-ink-soft">
              <span>Menu du jour · 14,90 €</span>
              <span className="hidden h-3 w-px bg-ink/25 sm:block" />
              <span>Supplément terrasse · 10 %</span>
            </div>
            <p className="mt-4 text-center font-serif text-base italic text-ink-soft">
              Veuillez signaler à notre équipe toute allergie ou intolérance.
            </p>
